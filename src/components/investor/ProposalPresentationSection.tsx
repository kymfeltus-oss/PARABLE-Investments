    ...
    >
      ...
      <div className="mt-6 flex w-full justify-center">
        <Link
          ...
          className="w-full max-w-md rounded-sm bg-[var(--cyan)] px-5 py-3.5 text-center text-sm font-bold tracking-tight text-black transition hover:brightness-105 active:brightness-95 sm:py-4 sm:text-base"
        >
