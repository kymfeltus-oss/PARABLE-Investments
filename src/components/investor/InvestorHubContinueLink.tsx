...
export function InvestorHubContinueLink() {
  ...
  if (ndaDone) {
    return (
      <div className="flex justify-center" suppressHydrationWarning>
        <Link
          href="/start"
          className="rounded-xl border border-[var(--cyan)]/40 bg-[var(--cyan)]/10 px-8 py-3.5 text-center text-sm font-black uppercase tracking-[0.2em] text-[var(--cyan)] transition hover:bg-[var(--cyan)]/20"
        >
          Continue to hub
        </Link>
      </div>
  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:justify-center" suppressHydrationWarning>
      <Link
        href="/nda?next=/start"
        className="rounded-xl border border-[var(--cyan)]/40 bg-[var(--cyan)]/10 px-6 py-3.5 text-center text-sm font-black uppercase tracking-[0.2em] text-[var(--cyan)] transition hover:bg-[var(--cyan)]/20"
      >
        Continue to NDA
      </Link>
      <Link
