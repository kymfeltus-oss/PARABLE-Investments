    ...
    <div className="relative min-h-dvh w-full overflow-hidden bg-black text-white">
      ...
      <div className="relative z-20 mx-auto flex w-full max-w-5xl flex-col px-4 py-8 pb-16 md:py-12">
        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3 text-[10px] font-semibold uppercase tracking-[0.2em]">
          <Link href="/start" className="text-[var(--cyan)]/80 transition hover:text-[var(--cyan)]">
            ← Choice hub
          </Link>
          <div className="flex flex-wrap gap-x-4 gap-y-1 text-white/45">
            ...
            <span className="text-[var(--cyan)]/70">Book a meeting</span>
          </div>
        </div>
        ...
        >
          <p className="parable-eyebrow text-[var(--cyan)]/90">The invitation</p>
        </motion.header>
          ...
          <div className="relative min-h-[min(52vh,28rem)] w-full sm:min-h-[32rem]">
            ...
            <div className="relative z-10 flex min-h-[min(52vh,28rem)] flex-col justify-end px-5 py-8 text-left sm:min-h-[32rem] sm:px-10 sm:py-12 md:justify-center md:py-14">
              ...
              <p className="mt-4 max-w-xl text-pretty text-sm leading-relaxed text-white/65 sm:mt-5 sm:text-base md:max-w-2xl">
                A direct line to our team: register with the email we have on file, pick a time that works for you, and
                step into a Parable meeting room with your NDA and room details in hand.
              </p>
              <div className="mt-7 flex w-full max-w-2xl flex-col gap-3 sm:mt-9 sm:flex-row sm:items-center sm:gap-4">
                <Link
                  ...
                  className="inline-flex w-full min-w-0 items-center justify-center rounded-xl bg-[var(--cyan)] px-6 py-3.5 text-sm font-bold tracking-tight text-black shadow-[0_0_32px_rgba(0, 242, 255,0.35)] transition hover:brightness-105 sm:w-auto sm:px-8 sm:py-4"
                >
                  Begin scheduling
                </Link>
                <Link
              ...
              <p className="mt-5 text-[11px] leading-relaxed text-white/35 sm:mt-6 sm:text-xs">
                First time: use <strong className="text-white/50">Begin scheduling</strong> to complete step 1. If you
                already finished registration, you can go straight to the calendar.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <p className="text-xs text-white/30">
            Not ready yet?{' '}
            <Link href="/investor/portal/hub" className="text-[var(--cyan)]/60 underline decoration-[var(--cyan)]/30 hover:text-[var(--cyan)]">
              Return to the hub
            </Link>
            .
          </p>
