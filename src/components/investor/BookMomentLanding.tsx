    ...
    <div className="relative min-h-dvh w-full overflow-hidden bg-black text-white">
      ...
      <div className="relative z-20 mx-auto flex w-full max-w-5xl flex-col px-4 py-8 pb-16 md:py-12">
        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3 text-[10px] font-semibold uppercase tracking-[0.2em]">
          <Link href="/start" className="text-[#00D4FF]/80 transition hover:text-[#00D4FF]">
            ← Choice hub
          </Link>
          <div className="flex flex-wrap gap-x-4 gap-y-1 text-white/45">
            ...
            <span className="text-[#00D4FF]/70">Book a meeting</span>
          </div>
        </div>
        ...
        >
          <p className="parable-eyebrow text-[#00D4FF]/90">The invitation</p>
        </motion.header>
            ...
            <div className="relative z-10 flex min-h-[min(52vh,28rem)] flex-col justify-end px-5 py-8 text-left sm:min-h-[32rem] sm:px-10 sm:py-12 md:justify-center md:py-14">
              ...
              <div className="mt-7 flex w-full max-w-2xl flex-col gap-3 sm:mt-9 sm:flex-row sm:items-center sm:gap-4">
                <Link
                  ...
                  className="inline-flex w-full min-w-0 items-center justify-center rounded-xl bg-[#00D4FF] px-6 py-3.5 text-sm font-bold tracking-tight text-black shadow-[0_0_32px_rgba(0, 212, 255,0.35)] transition hover:brightness-105 sm:w-auto sm:px-8 sm:py-4"
                >
                  Begin scheduling
                </Link>
                <Link
        ...
        >
          <p className="text-xs text-white/30">
            Not ready yet?{' '}
            <Link href="/investor/portal/hub" className="text-[#00D4FF]/60 underline decoration-[#00D4FF]/30 hover:text-[#00D4FF]">
              Return to the hub
            </Link>
            .
          </p>
