...
export default function ParableDemoPage() {
  return (
    <NdaGate>
      <div className="relative min-h-screen bg-[var(--bg-black-soft)] text-white">
        <div
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-5 pb-20 pt-10 sm:px-8 md:pt-14">
          ...
          <header className="mt-10 text-center md:mt-12">
            <p className="text-[10px] font-black uppercase tracking-[0.38em] text-[var(--cyan)]/65">Five pillars</p>
            <h1 className="mt-3 text-balance text-2xl font-black uppercase tracking-[0.1em] text-[var(--cyan)] sm:text-3xl">
              Parable pillar demo
            </h1>
            <p className="mx-auto mt-4 max-w-2xl text-pretty text-sm leading-relaxed text-white/55">
              ...
              <code className="rounded bg-white/10 px-1 font-mono text-[11px] text-[var(--cyan)]/85">NEXT_PUBLIC_PARABLE_PROTOTYPE_URL</code> on{' '}
              <Link href="/explore" className="text-[var(--cyan)]/90 underline decoration-[var(--cyan)]/30 underline-offset-2 hover:text-[var(--cyan)]">/explore</Link>.
            </p>
          </header>
