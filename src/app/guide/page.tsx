...
const h2 = 'mb-4 text-[10px] font-black uppercase tracking-[0.32em] text-[var(--cyan)]/85';
const p = 'text-sm leading-relaxed text-white/60 md:text-[15px]';
const ul = 'ml-1 list-outside list-decimal space-y-3 pl-4 text-sm leading-relaxed text-white/60 marker:text-[var(--cyan)]/70 md:pl-5 md:text-[15px]';
    ...
    <div className="relative min-h-screen w-full overflow-x-hidden bg-[#030304] text-white">
      ...
      <div className="relative z-20 mx-auto min-h-screen max-w-2xl px-4 py-8 pb-24 sm:px-6 md:max-w-3xl md:px-8 md:py-12">
        <header className="mb-10 border-b border-white/[0.08] pb-8 text-center">
          <Link
            href="/"
            className="mb-6 inline-flex items-center gap-2 rounded-full border border-[var(--cyan)]/25 bg-black/50 px-3 py-2 text-[9px] font-black uppercase tracking-[0.26em] text-[var(--cyan)]/85 backdrop-blur-md transition hover:border-[var(--cyan)]/45"
          >
            <span aria-hidden>←</span> Landing
          </Link>
          <div className="mt-2 flex flex-col items-center">
            <ParableLogoMark className="w-full max-w-[10rem] opacity-95" />
            <p className="mt-3 text-[10px] font-black uppercase tracking-[0.4em] text-[var(--cyan)]/75">Investor</p>
        ...
        <article>
          <section className={section} aria-labelledby="g-quick">
            ...
            <ol className={ul}>
              ...
              <li>
                After you are cleared → you will land on the <Link className="text-[var(--cyan)] underline-offset-2 hover:underline" href="/start">investor hub (choice hub)</Link> at <span className={kbd}>/start</span>.
              </li>
              <li>
          ...
          <section className={section} aria-labelledby="g-start">
            ...
            <ul className="ml-1 list-outside list-disc space-y-2.5 pl-4 text-sm leading-relaxed text-white/60 marker:text-[var(--cyan)]/60 md:pl-5 md:text-[15px]">
              <li>
        ...
        <footer className="mt-12 border-t border-white/[0.08] pt-8 text-center">
          <Link
            href="/start"
            className="inline-flex min-h-11 min-w-[12rem] items-center justify-center rounded-2xl border border-[var(--cyan)]/40 bg-[var(--cyan)]/10 px-6 py-2.5 text-sm font-black uppercase tracking-[0.2em] text-[var(--cyan)] transition hover:bg-[var(--cyan)]/20"
          >
            Go to investor hub →
          </Link>
        </footer>
